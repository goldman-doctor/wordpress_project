<?php get_header('guyners'); ?>    
    ...
    <section class='breadcrumb'>
        ...
        <p class='breadcrumb-arrow'>></p>
        <p><?php the_field('player_name', $member_id); ?></p>
    </section>
    ...
    <section class="player-detail-contents">
        <div class="player-profile">
			<div class="player-profile-inner">
				<div class="player-profile-img pc">
					<?php
					$player_img = get_field('player_detail_img', $member_id);
					if ($player_img):
					?>
						<img src="<?php echo esc_url($player_img['url']); ?>" alt="<?php echo esc_attr($player_img['alt']); ?>" class="player-detail-img">
					<?php endif; ?>
				</div>
				<div class="player-profile-txt">
					<h2>
						<span class="player-num"><?php the_field('player_number', $member_id); ?></span>
						<span class="player-name"><?php the_field('player_name', $member_id); ?></span>
					</h2>
					<h6 class="en-name"><?php echo strtoupper(get_field('player_en_name', $member_id)); ?></h6>
					<h5 class="player-role"><?php the_field('player_role', $member_id); ?></h5>
					<div class='player-info pc'>
						<p class="player-style"><?php the_field('player_style', $member_id); ?></p>
						<p>
							<span class="dob"><?php the_field('player_birthday', $member_id); ?>生</span>
							<span class="player-height"><?php the_field('player_height', $member_id); ?>cm</span>
							<span class="player-weight"><?php the_field('player_weight', $member_id); ?>kg</span>
						</p>
					</div>					
				</div>
		...
		<div class="player-origin">
			<div class="player-origin-item">
				<p>出身</p>
				<p><?php the_field('player_county', $member_id); ?></p>
			</div>
			<div class="player-origin-item">
				<p>IL在籍年数</p>
			...
			<div class="player-origin-item">
				<p>球歴</p>
				<p><?php the_field('player_career', $member_id); ?></p>
			</div>
		</div>
		...
		<div class="player-sponsors">
            ...
            <div class="player-sponsors-inner">
				...
				<?php 
					$player_name = get_field('player_name', $member_id);
