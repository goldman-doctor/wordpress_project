...
<section class="members-contents">
	<div class="members-anchor">
		...
		<a href="<?php echo home_url(); ?>/member_coaches" class="noselect">監督・コーチ・トレーナー</a>
	...
	<div class="members-contents-inner">
		<div class="members-inner-box">
			<div class="members-caption">
				<h3 class="sec_title_green">PITCHER</h3>
				<p class="sec_subtitle_green">投手</p>
			</div>
		...
		<div class="members-inner-box">
			<div class="members-caption">
				<h3 class="sec_title_green">CATCHER</h3>
				<p class="sec_subtitle_green">捕手</p>
			</div>
			<div class="members-intro-boxes">
		...
		<div class="members-inner-box">
			<div class="members-caption">
				<h3 class="sec_title_green">OUTFIELDER</h3>
				<p class="sec_subtitle_green">外野手</p>
			</div>
			<div class="members-intro-boxes">
